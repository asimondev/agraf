...
create table graf_sqlstat (
  ...
  primary key(sql_id, instance_number, end_interval_time)
)
\g
...
from (
  select b.snap_id, b.instance_number, 
    ...
    b.end_interval_time
  from hist_sqlstat b
  group by b.instance_number, b.snap_id, b.end_interval_time, b.sql_id
) a
\g

update graf_sqlstat a, hist_sys_time_model b
set a.db_time = b.dif_value
where a.instance_number = b.instance_number and
...
update graf_sqlstat a, hist_sysstat b
