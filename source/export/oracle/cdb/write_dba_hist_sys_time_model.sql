...
-- 
-- Select data from CDB DBA_HIST_SYS_TIME_MODEL into CSV file.
-- 
...
spool &OUT_DIR./hist_sys_time_model.csv

with v as (
select a.snap_id, a.instance_number, b.startup_time,
  a.stat_id, a.stat_name, a.value old_value,
  a.value - lag(a.value)
    over(partition by a.dbid, a.instance_number, b.startup_time, a.stat_id
    order by a.snap_id) dif_value,
  b.end_interval_time,
  b.end_interval_time - lag(b.end_interval_time)
    over (partition by b.dbid, b.instance_number, b.startup_time, a.stat_id
