...
-- 
-- Main script to select release 11g AWR data into CSV files.
-- 
...
spool &OUT_DIR./export_data_11g.log
prompt >>> AGRAF Version 0.1 
prompt >>> Running export_data_11g.sql 
...
@non_cdb/write_dba_hist_dyn_remaster_stats_11g
