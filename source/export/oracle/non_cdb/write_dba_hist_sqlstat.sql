...
select a.snap_id, a.dbid, a.instance_number, b.startup_time,
  ...
  a.io_offload_elig_bytes_total - lag(a.io_offload_elig_bytes_total)
    over(partition by a.dbid, a.instance_number, b.startup_time, a.sql_id, 
    a.plan_hash_value order by a.snap_id) dif_io_offload_elig_bytes,
  ...
  a.io_interconnect_bytes_total - lag(a.io_interconnect_bytes_total)
    over(partition by a.dbid, a.instance_number, b.startup_time, a.sql_id, 
    a.plan_hash_value order by a.snap_id) dif_io_interconnect_bytes,
  ...
  a.physical_read_requests_total - lag(a.physical_read_requests_total)
    over(partition by a.dbid, a.instance_number, b.startup_time, a.sql_id, 
    a.plan_hash_value order by a.snap_id) dif_physical_read_requests,
  ...
  a.optimized_physical_reads_total - lag(a.optimized_physical_reads_total)
    over(partition by a.dbid, a.instance_number, b.startup_time, a.sql_id, 
    a.plan_hash_value order by a.snap_id) dif_optimized_physical_reads,
  ...
  a.cell_uncompressed_bytes_total - lag(a.cell_uncompressed_bytes_total)
    over(partition by a.dbid, a.instance_number, b.startup_time, a.sql_id, 
    a.plan_hash_value order by a.snap_id) dif_cell_uncompressed_bytes,
  ...
  a.io_offload_return_bytes_total - lag(a.io_offload_return_bytes_total)
    over(partition by a.dbid, a.instance_number, b.startup_time, a.sql_id, 
    a.plan_hash_value order by a.snap_id) dif_io_offload_return_bytes,
  b.end_interval_time,
  b.end_interval_time - lag(b.end_interval_time)
    over (partition by b.dbid, b.instance_number, b.startup_time, a.sql_id,
    a.plan_hash_value order by a.snap_id) dif_ivl,
  'x;\N;\N;x' con_id
